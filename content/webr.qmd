...
Conveniently, we can also see the dollar sign operator, which allows us to access variables in our dataframe.
...
You could call it anything you like, but 'fit' is quite common for a fitted model.
